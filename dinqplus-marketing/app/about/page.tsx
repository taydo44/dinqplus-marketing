  ...
  const services = [
    {
      ...
      description: "We build fast, modern websites and web apps for Ethiopian businesses. From landing pages to full SaaS platforms — clean code, great design.",
      position: "left",
    },
    {
      ...
      title: "SaaS Products",
      description: "We design and build subscription software products. Dinq+ is our own SaaS — proof that we build what we sell.",
      position: "left",
    },
    {
      ...
      title: "UI/UX Design",
      description: "Beautiful, functional interfaces built for real users. We design with purpose — every screen has a job to do.",
      position: "left",
    },
    {
      ...
      secondaryIcon: <Sparkles className="w-4 h-4 absolute -top-1 -right-1 text-[#A9BBC8]" />,
      title: "Mobile Apps",
      description: "iOS and Android apps for Ethiopian entrepreneurs. We build mobile-first products that work everywhere.",
      position: "right",
    },
    {
      ...
      description: "Logo, colors, typography — we build brands that stand out. Ethiopian businesses deserve world-class design.",
      position: "right",
    },
    {
      ...
      description: "We integrate AI into your products and workflows. Smarter scheduling, automation, and business intelligence.",
      position: "right",
    },
  ]
      ...
      >
        ...
        >
          ...
          >
            ...
            <motion.button
              className="bg-[#88734C] hover:bg-[#88734C]/90 text-white px-6 py-3 rounded-lg flex items-center gap-2 font-medium transition-colors cursor-pointer border-none"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
